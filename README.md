...
| `collectMerchantFreebies`   | If `true`, collects free daily/weekly/monthly rewards from the Merchants page. [**Please keep in mind this only works if you have no "Special Daily Bundles"!**](https://github.com/zebscripts/AFK-Daily/issues/39) |    `false`     |
